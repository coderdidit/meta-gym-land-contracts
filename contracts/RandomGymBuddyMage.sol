...
contract RandomGymBuddy is ERC721URIStorage, VRFConsumerBaseV2, Ownable {
    ...
    uint256 internal constant OFFSET_OF_METADATA_FILE_ID = 1;
    uint256 internal constant MAX_ID_OF_METADATA_FILE = 1;
        ...
        override
    {
        ...
        uint256 uriMetadataFileID = (randomWords[0] % MAX_ID_OF_METADATA_FILE) + OFFSET_OF_METADATA_FILE_ID;
    ...
    {
        string
            memory cid = "bafybeia45ybvuxcobtvrdhcfs4cxm4yfct37ptopqa5fy2i4dplvjtmrka";
